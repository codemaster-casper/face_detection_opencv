...
#Video is a continous sequence of frames. Creating infinite loop to show to frames continously. 
while True:

    #Reading the video source object and storing each frame in the "frame"
    ...
    #implementing the face cascade classifire to the gray frames
    ...
    #Displaying frame by frame in a window as video
